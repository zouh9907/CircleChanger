...
class CircleChanger(object):
    ...
    def get_distance_from(self, point):
        ...
        ################################################################
        distance = math.sqrt((self.circle.center.x - point.x)**2 + (self.circle.center.y - point.y)**2)
        return distance
    ...
    def swallow(self, other_circle_changer):
        ...
        cc = CircleChanger(x, y, radius, 'red', color)
        return cc
    ...
    def change_to_original_color(self):
        ...
        #   (below).  Third, implement and test this method.
        ################################################################
        self.circle.fill_color = self.ini_color
